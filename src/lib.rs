...
#[derive(Debug)]
pub struct ColorSchemeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ColorSchemeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ColorScheme processing");
    
    let mut processor = ColorSchemeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ColorSchemeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ColorSchemeProcessor::new(false);
